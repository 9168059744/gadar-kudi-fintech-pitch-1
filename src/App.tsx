...
import {
  ...
  GraduationCap, Sprout, Heart, Building2, ArrowRight, CheckCircle2,
  MessageCircle, Send, Phone, Mail, MapPinned, Sparkles, Target,
  Lightbulb, HandCoins, BarChart3, Clock, Lock, Zap
} from 'lucide-react';
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-border/50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#cta" className="px-4 py-2 rounded-lg bg-gradient-green text-white text-sm font-semibold hover:opacity-90 transition-opacity">
                {t('nav.getStarted')}
              </a>
              <LanguageSwitcher />
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-border p-4 space-y-3">
            ...
            <a href="#cta" className="block w-full text-center px-4 py-2 rounded-lg bg-gradient-green text-white text-sm font-semibold">
              {t('nav.getStarted')}
            </a>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center">
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#cta" className="px-8 py-4 rounded-xl bg-gradient-gold text-[#003319] font-bold text-lg hover:opacity-90 transition-opacity shadow-lg">
                {t('hero.startJourney')}
              </a>
                ...
                <div className="bg-gradient-green rounded-3xl p-8 text-white">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {['Send', 'Save', 'Pay'].map(action => (
                        <button key={action} className="py-3 bg-white/10 rounded-xl text-sm font-medium hover:bg-white/20 transition-colors">
                          {action}
                        </button>
                      ))}
                    </div>
                    <div className="p-4 bg-white/10 rounded-xl">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm text-white/70">Savings Goal</span>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.div variants={fadeInUp}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <a href="#contact" className="px-8 py-4 rounded-xl bg-gradient-gold text-[#003319] font-bold text-lg hover:opacity-90 transition-opacity shadow-lg inline-flex items-center justify-center gap-2">
